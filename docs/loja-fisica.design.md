...
- Ajustes de 25/09/2026: véu verde leve na foto do hero (bem mais suave que o das LPs de anúncio), folha vetorial do cabeçalho removida (usar o logo real quando houver um arquivo próprio para fundo claro) e WhatsApp do cabeçalho só como ícone verde, sem texto.
