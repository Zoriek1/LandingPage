...
export default function WhatsAppLeadModal() {
  ...
  function proceed(skipPhone = false) {
    if (!skipPhone && phone.replace(/\D/g, "").length >= 10) {
  ...
  return (
    ...
    >
      ...
      {/* Sheet */}
      <div
        className="relative w-full sm:max-w-sm bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-4 duration-300"
      ...
      >
        ...
        <div className="px-6 pt-5 pb-6">
          ...
          <input
            ...
            onKeyDown={(e) => e.key === "Enter" && proceed(false)}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-[#25D366] text-white font-semibold text-sm tracking-wide uppercase py-4 rounded-2xl shadow-lg shadow-[#25D366]/30 hover:brightness-110 active:scale-95 transition-all mb-3"
          >
