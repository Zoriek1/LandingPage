...
const GuaranteeSection = () => (
  <section className="bg-secondary/40 py-section-y">
    <div className="container">
      <motion.div
        ...
        className="mx-auto flex max-w-3xl flex-col items-center rounded-[28px] border border-accent/20 bg-background px-6 py-12 text-center shadow-[0_24px_60px_hsl(var(--primary)_/_0.08)] md:px-12 md:py-14"
      >
        ...
        <span className="mb-4 inline-flex items-center rounded-full border border-accent/25 bg-accent/10 px-4 py-1.5 font-body text-eyebrow font-semibold uppercase text-accent">
          Garantia Plante Uma Flor
        </span>
        <h2 className="mb-4 max-w-xl font-display text-h3 font-semibold text-primary">
