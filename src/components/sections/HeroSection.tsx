    ...
    <div className="container relative z-10 py-32 md:py-40">
      <div className="max-w-2xl">
        ...
        <motion.p
          ...
          className="font-body text-xl md:text-2xl font-medium text-primary-foreground/90 mb-10 max-w-lg leading-relaxed"
        >
        ...
        >
          <button
            ...
            className="flex items-center justify-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-2xl font-body text-base font-semibold tracking-widest uppercase hover:brightness-110 transition-all text-center shadow-lg shadow-[#25D366]/30"
          >
          ...
          <a
            ...
            className="flex items-center justify-center border border-primary-foreground/30 text-primary-foreground/90 px-5 py-3 rounded font-body text-base font-medium tracking-widest uppercase hover:bg-primary-foreground/10 transition-all text-center"
          >
            Ver Catálogo
          </a>
        </motion.div>
        ...
        >
          {badges.map((b) => (
            <div key={b.label} className="flex items-center gap-2 text-primary-foreground/90">
              ...
              <span className="font-body text-base font-medium">{b.label}</span>
            </div>
          ))}
        </motion.div>
      </div>
