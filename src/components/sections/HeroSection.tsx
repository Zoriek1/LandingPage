...
const badges = [
  ...
  { icon: ShieldCheck, label: "Encomenda com data combinada" },
  { icon: Flower2, label: "Buquês, cestas e plantas" },
];
    ...
    <div className="container relative z-10 py-32 md:py-40">
      <div className="max-w-2xl">
        <motion.h1
          ...
          className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-primary-foreground leading-snug mb-5"
        >
          Buquês e arranjos sob encomenda em Goiânia
        </motion.h1>
        ...
        <motion.p
          ...
          className="font-body text-base md:text-lg text-primary-foreground/85 mb-8 max-w-md leading-relaxed"
        >
          Valores e fotos no catálogo. No WhatsApp, envie data da entrega, bairro e ocasião — montamos o orçamento.
        </motion.p>
          ...
          <button
            onClick={() =>
              openWhatsAppModal(WHATSAPP_URL, {
                cta_location: "hero",
                cta_label: "comprar_no_whatsapp",
                destination_url: WHATSAPP_URL,
              })
            }
            className="flex items-center justify-center gap-3 bg-[#25D366] text-white px-7 py-3.5 rounded-2xl font-body text-sm font-semibold tracking-wide uppercase hover:brightness-110 transition-all text-center shadow-lg shadow-[#25D366]/30"
          >
