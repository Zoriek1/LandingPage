...
import { useFeaturedProducts } from "@/features/namorados/hooks/useFeaturedProducts";
        ...
        >
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-3xl font-semibold text-primary md:text-4xl">
              Os mais pedidos para o Dia dos Namorados
            </h2>
            <p className="mt-3 max-w-xl font-body text-sm leading-7 text-muted-foreground md:text-base">
              Buquês e combos que mais saem na semana do dia 12/06. Foto, preço e link prontos pra finalizar.
            </p>
          </div>
