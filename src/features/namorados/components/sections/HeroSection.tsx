      ...
      <div className="container relative z-10 py-28 md:py-40">
        <div className="max-w-2xl">
          ...
          <motion.h1
            ...
            className="mb-5 max-w-[14ch] font-display text-[2.7rem] font-bold leading-[1.04] tracking-[-0.02em] text-primary-foreground [text-shadow:0_12px_36px_rgba(0,0,0,0.42)] sm:max-w-[14ch] sm:text-[3.15rem] md:max-w-none md:text-5xl md:leading-[1.06]"
          >
          ...
          <motion.p
            ...
            className="mb-9 max-w-[34ch] font-body text-[1.06rem] font-medium leading-8 [text-shadow:0_10px_28px_rgba(0,0,0,0.68)] md:mb-10 md:max-w-xl md:text-lg md:font-normal"
