    ...
    <div className="container relative z-10 text-center">
      ...
      >
        ...
        <button
          ...
          className="inline-flex items-center gap-3 bg-accent text-accent-foreground px-10 py-5 rounded font-body text-base font-bold tracking-widest uppercase hover:brightness-110 transition-all shadow-lg shadow-accent/30"
        >
