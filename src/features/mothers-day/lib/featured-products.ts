import featuredProductsSnapshot from "@/features/mothers-day/data/featured-products.snapshot.json";
import type { FeaturedProduct } from "@/features/mothers-day/types";

export const FEATURED_PRODUCTS_ENDPOINT = "/dia-das-maes/featured-products.json";
