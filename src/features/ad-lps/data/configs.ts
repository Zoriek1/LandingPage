...
export const PRODUCTS: Record<string, Product> = {
  ...
  "buque-6-rosas": {
    ...
    priceBrl: "R$ 325,90",
    installments: "3x s/ juros de R$ 108,63",
    ...
    waText: "Oi! Quero o Buquê Clássico de Rosas Vermelhas (R$ 325,90).",
    details: {
      flowerCount: 6,
      size: "M",
      heightCm: 40,
  ...
  "arranjo-lirios-p": {
    ...
    waText: "Oi! Quero o Arranjo de Mão Lírios P (R$ 199,90).",
    details: {
      size: "P",
      heightCm: 35,
  ...
  "arranjo-mao-lirios": {
    ...
    installments: "3x s/ juros de R$ 66,63",
    image: "https://acdn-us.mitiendanube.com/stores/006/718/510/products/41-28b68fc71bb1cd62fc17739779592690-1024-1024.webp",
    waText: "Oi! Quero o Arranjo de Mão Lírios M (R$ 199,90).",
    details: {
      size: "M",
      heightCm: 42,
      includes: ["Papel jornal artesanal", "Cartão à mão"],
  ...
  "buque-lirios": {
    ...
    priceBrl: "R$ 335,90",
    installments: "3x s/ juros de R$ 111,97",
    image: "https://acdn-us.mitiendanube.com/stores/006/718/510/products/25-a22098d763e0c73efe17739780254780-1024-1024.webp",
    waText: "Oi! Quero o Buquê de Lírios P (R$ 335,90).",
    details: {
      size: "P",
      heightCm: 42,
      includes: ["Papel artesanal", "Fita de cetim", "Cartão à mão"],
