...
export const PRODUCTS: Record<string, Product> = {
  ...
  "buque-rosas-astromelias": {
    ...
    waText: "Oi! Quero o Buquê de Rosas com Astromélias (R$ 259,90).",
    details: {
      flowerCount: 6,
      size: "M",
      heightCm: 42,
  ...
  "buque-lirios-m": {
    ...
    waText: "Oi! Quero o Buquê de Lírios M (R$ 425,90).",
    details: {
      size: "M",
      heightCm: 50,
      includes: ["Papel artesanal", "Fita de cetim", "Cartão à mão"],
  ...
  "buque-lirios-g": {
    ...
    image: "https://acdn-us.mitiendanube.com/stores/006/718/510/products/25-a22098d763e0c73efe17739780254780-1024-1024.webp",
    waText: "Oi! Quero o Buquê de Lírios G (R$ 550,90).",
    details: {
      size: "G",
      heightCm: 60,
      includes: ["Papel artesanal", "Fita de cetim", "Cartão à mão"],
  ...
  "buque-girassois-p": {
    ...
    waText: "Oi! Quero o Buquê de Girassóis P (R$ 229,90).",
    details: {
      flowerCount: 6,
      size: "P",
      heightCm: 40,
...
Object.assign(LP_CONFIGS, {
  ...
  girassol: {
    ...
    vitrineTitle: "Girassóis para presentear", vitrineProductIds: ["girassol-avulso", "arranjo-2-girassois-balao", "buque-girassois-p", "buque-girassois-m"],
